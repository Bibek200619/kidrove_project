      ...
      <div className="relative mx-auto flex min-h-[84svh] max-w-7xl flex-col px-4 py-5 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center py-12">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <div className="mb-5 inline-flex items-center gap-2 rounded-lg border border-amber-200 bg-white/80 px-4 py-2 text-sm font-bold text-amber-700 shadow-sm backdrop-blur">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <button
                ...
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-rose-500 px-6 py-3 font-bold text-white shadow-lg shadow-rose-200 transition hover:bg-rose-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500"
              >
                Enroll Now
